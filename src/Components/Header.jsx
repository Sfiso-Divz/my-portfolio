        ...
        <div className='flex flex-col justify-center items-center h-screen text-center text-gray-700 px-6'>
            ...
            <div className="flex gap-12 mt-6">
                <div className="flex flex-col justify-center items-center cursor-pointer hover:scale-105 ease-in-out duration-300">
                    <a href="https://github.com/Sfiso-Divz" className="mt-2 md:mt-4 "><FaGithub size={36} className="text-[#5151FF] mb-2"/> Github</a>
                </div>
                <div className="flex flex-col justify-center items-center cursor-pointer hover:scale-105 ease-in-out duration-300">
                     
                    <a href="https://x.com/Sfiso_Divz" className="mt-2 md:mt-4 "><FaTwitter size={36} className="text-[#5151FF] mb-2"/>Twitter</a>
                </div>
                <div className="flex flex-col justify-center items-center cursor-pointer hover:scale-105 ease-in-out duration-300">
                    
                    <a href="https://www.linkedin.com/in/mfihlo-dlamini-7193092a3/" className="mt-2 md:mt-4 "><FaLinkedin size={36} className="text-[#5151FF] mb-2"/> LinkedIn</a>
                </div>
            </div>
        </div>
    </div>
